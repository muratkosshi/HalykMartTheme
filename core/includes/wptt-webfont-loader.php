...
if ( ! class_exists( 'Mega_Store_Woocommerce_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Mega_Store_Woocommerce_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Mega_Store_Woocommerce_WPTT_WebFont_Loader( $url );
