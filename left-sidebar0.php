...
<div class="">
	<div class="row">
		<div class="col-md-2">
			<img style="    width: 100%;" src="/wp-content/uploads/2023/01/logo_white.png" alt="">
		</div>
...
<div class="bg-gray">
  ...
  <h1 class="mt-2"> HALYKMART  </h1>
						  ...
						  <?php if(ICL_LANGUAGE_CODE=='kk'): ?>
<h2>Онлайн гипермаркет сенің смартфоныңда!</h2>
						<p>Біз Сіздің көмекшілеріңіз боламыз және өнімдерді сатып алу процесін мүмкіндігінше тез әрі жеңіл  болуын қамтамасыз етеміз
</p>
						<h3 class="mobile-size-text">Нөміріңізді тіркеңіз және 1000 тг бонус алыңыз! </h3>
		...
		<div class="container pt-4 section-inform mobile-center">
			...
			<?php if(ICL_LANGUAGE_CODE=='kk'): ?>
			<h3 class="text-center font-color" style="color: black;">HALYKMART - Ақтөбе қаласы бойынша балғын азық - түлік өнімдерінің, сусындардың  және күнделікті қажетті өнімдердің кең ассортименті бар жеткізу қызметі!</h3>
<?php elseif(ICL_LANGUAGE_CODE=='ru'): ?>
...
<?php endif;?>
			...
			<?php if(ICL_LANGUAGE_CODE=='kk'): ?>
			<h2 class="text-center font-color">Не үшін бізден сатып алу керек? </h2>
<?php elseif(ICL_LANGUAGE_CODE=='ru'): ?>
			...
			<div class=" icons-list text-center" >
				...
				<div class="col-md-3">
					<div class="card">
						...
						<?php if(ICL_LANGUAGE_CODE=='kk'): ?>
								<p>30 000 астам тауар атаулары!</p>
<?php elseif(ICL_LANGUAGE_CODE=='ru'): ?>
...
<?php endif;?>
				...
				<div class="col-md-3">
					<div class="card">
						...
						<?php if(ICL_LANGUAGE_CODE=='kk'): ?>
						<p>Есікке дейін тегін жеткізу!</p>
<?php elseif(ICL_LANGUAGE_CODE=='ru'): ?>
...
<?php endif;?>
				...
				<div class="col-md-3">
					<div class="card">
						...
						<?php if(ICL_LANGUAGE_CODE=='kk'): ?>
						<p>Тауарды алғаннан кейін карта мен немесе қолма- қол ақшамен төле!</p>
...
<?php endif;?>
				...
				<div class="col-md-3">
					<div class="card">
						...
						<?php if(ICL_LANGUAGE_CODE=='kk'): ?>
						<p>Промокод пен бонустар жина!</p>
<?php elseif(ICL_LANGUAGE_CODE=='ru'): ?>
...
<h2 class="mobile-size-text">	Сіздің нөміріңіз тіркелді!!</h2>
<?php elseif(ICL_LANGUAGE_CODE=='ru'): ?>
...
Тіркелгеніңіз үшін рахмет! Сіздің бонустық шотыңызға 1000 тг түсті.
...
<?php endif;?>
	...
	<a href="/shop/" style="    color: #9462ff;
    background: #ff6a00;
    color: white;
		font-size: 24px;
    border-radius: 32px;
...
Каталогқа өту
    ...
    color: white;
    border-radius: 32px;
    padding: 10px;">Нөмеріңді тіркеп <br> 1000 тг бонус ал!</h2>
<?php elseif(ICL_LANGUAGE_CODE=='ru'): ?>
						<h2 class="text-center font-color" style="    color: #9462ff;
    background: #ff6a00;
    color: white;
...
<?php endif;?>
 ...
 Сізге ыңғайлы болу үшін, Kaspi Red - ті  іске қостық. Қазір тапсырыс беріп, төлемді кейін жаса.</h2>
<?php elseif(ICL_LANGUAGE_CODE=='ru'): ?>
			<h2 class="text-center">
...
document.body.innerHTML = document.body.innerHTML.replace(/First Name/g, 'Аты - жөні');
document.body.innerHTML = document.body.innerHTML.replace(/Mobile Number/g, 'Ұялы телефон нөмері');
			document.body.innerHTML = document.body.innerHTML.replace(/Signup/g, 'Тіркеу');
			</script>
